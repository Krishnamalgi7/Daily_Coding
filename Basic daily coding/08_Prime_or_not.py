...
Description:
    ...
    Method 2: Optimized approach using the math.sqrt() library.
Complexity:
...
if flag == 1:
    print(f"Method 2: The number {num} is not a prime number.")
else:
    print(f"Method 2: The number {num} is a prime number.")